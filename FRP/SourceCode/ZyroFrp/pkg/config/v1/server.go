...
type ServerConfig struct {
	...
	// ServerName specifies the unique identifier for this server instance.
	// This value must be configured and will be used for tunnel authentication.
...
func (c *ServerConfig) Complete() error {
	...
	// ServerName is required for tunnel authentication
	if c.ServerName == "" {
		return fmt.Errorf("serverName is required for tunnel authentication")
	}
