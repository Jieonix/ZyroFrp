...
CREATE TABLE `frp_tunnels` (
  ...
  `server_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tunnel_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tunnel_type` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `local_ip` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `local_port` int NOT NULL,
  `remote_port` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `server_ip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  UNIQUE KEY `UK22g8yougain4r3yj559gum78l` (`server_name`,`remote_port`),
...
INSERT INTO `frp_tunnels` VALUES (15,'2040804972@qq.com','4ii057kne8u8jice2iva','香港1号','Tunnel-01','tcp','127.0.0.1',22,10000,'2025-08-22 16:24:02','2025-08-22 16:24:02','8.1.2.2',NULL,NULL),(18,'2040804972@qq.com','4ii057kne8u8jice2iva','美国1号','Tunnel-02','tcp','127.0.0.1',22,10000,'2025-08-22 17:51:04','2025-08-22 17:51:04','2.5.3.3',NULL,NULL),(19,'2040804972@qq.com','4ii057kne8u8jice2iva','美国1号','Tunnel-03','tcp','127.0.0.1',3306,10001,'2025-08-22 17:51:50','2025-08-22 17:51:50','2.5.3.3',NULL,NULL);
...
CREATE TABLE `servers` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `allow_high_traffic` bit(1) NOT NULL,
  `allow_udp` bit(1) NOT NULL,
  `allow_website` bit(1) NOT NULL,
  `current_tunnels` int NOT NULL,
  `domain` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `info` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `port_range` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `servers` VALUES (1,'香港1号','8.1.2.2',7788,100,1,0,'OFFLINE','2025-03-19 10:37:06','2025-08-22 17:50:17',_binary '',_binary '',_binary '',1,'hk1.zyroo.cn','香港服务器-1号 (1Gbps) [公益服务器] ','10000-65535'),(2,'美国1号','2.5.3.3',7788,100,1,0,'OFFLINE','2025-08-19 13:28:38','2025-08-22 17:50:17',_binary '',_binary '',_binary '',2,'us1.zyroo.cn','美国服务器-1号 (500Mbps)  [公益服务器]','10000-65535');
...
INSERT INTO `user_answers` VALUES (2,'2040804972@qq.com',10,'A',1,'2025-03-21'),(3,'2040804972@qq.com',1,'B',1,'2025-03-22'),(4,'2040804972@qq.com',3,'B',1,'2025-03-24'),(5,'2040804972@qq.com',5,'B',1,'2025-03-26'),(6,'2040804972@qq.com',1,'B',1,'2025-08-19'),(7,'sj2040804972@gmail.com',1,'B',1,'2025-08-19'),(8,'2040804972@qq.com',2,'C',1,'2025-08-20'),(20,'2040804972@qq.com',5,'B',1,'2025-08-23'),(26,'2040804972@qq.com',5,'B',1,'2025-08-24');
...
INSERT INTO `users` VALUES (10000,'4ii057kne8u8jice2iva','2040804972@qq.com','$2a$10$sBP5GanxBufLO8g4PtxiJ.WgR5ZtmDfYjjHxZKT/bVEz90ILGldsi',1,'USER','2025-03-18 19:17:42','2025-08-22 17:42:43',5945.959999999998,1000,1000,1,'沙杰','HZIGl5j+UexIV+vzk13LDKptRBTgN+bvZ4pzNTpvyGc=',0,'2100-08-23','2025-08-23'),(10001,'rm175v5fkbaburbmcekq','sj2040804972@gmail.com','$2a$10$BN088NUgpuHjyRkB.WITF.TmM.d3d09DJPhmlVToj2V11kLrtClfC',0,'User','2025-08-19 13:46:32','2025-08-22 17:39:43',4101.376,2000,2000,1,'沙杰','HZIGl5j+UexIV+vzk13LDKptRBTgN+bvZ4pzNTpvyGc=',1,NULL,NULL);
...
-- Dump completed on 2025-08-24 21:33:41
